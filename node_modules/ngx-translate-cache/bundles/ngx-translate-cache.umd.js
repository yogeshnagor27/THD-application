(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-translate-cache', ['exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-translate-cache'] = {}, global.ng.core, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var COOKIE_EXPIRY = new core.InjectionToken('COOKIE_EXPIRY');
    var DEFAULT_CACHE_NAME = 'lang';
    var DEFAULT_CACHE_MECHANISM = exports.CacheMechanism.LocalStorage;
    ...
    var TranslateCacheSettings = /** @class */ (function () {
        ...
        TranslateCacheSettings.ctorParameters = function () { return [
            ...
            { type: String, decorators: [{ type: core.Inject, args: [CACHE_MECHANISM,] }] },
            { type: Number, decorators: [{ type: core.Inject, args: [COOKIE_EXPIRY,] }] }
        ]; };
        TranslateCacheSettings = __decorate([
            core.Injectable(),
            __param(0, core.Inject(CACHE_NAME)),
            __param(1, core.Inject(CACHE_MECHANISM)),
            __param(2, core.Inject(COOKIE_EXPIRY))
    ...
    var TranslateCacheService = /** @class */ (function () {
        ...
        TranslateCacheService.prototype.init = function () {
            ...
            this.translateService.onLangChange
                ...
                if (_this.translateCacheSettings.cacheMechanism === exports.CacheMechanism.LocalStorage) {
                    return _this.cacheWithLocalStorage(event.lang);
                }
                if (_this.translateCacheSettings.cacheMechanism === exports.CacheMechanism.Cookie) {
        ...
        TranslateCacheService.prototype.getCachedLanguage = function () {
            if (this.translateCacheSettings.cacheMechanism === exports.CacheMechanism.LocalStorage) {
                return this.cacheWithLocalStorage();
            }
            if (this.translateCacheSettings.cacheMechanism === exports.CacheMechanism.Cookie) {
    ...
    exports.COOKIE_EXPIRY = COOKIE_EXPIRY;
    exports.TranslateCacheModule = TranslateCacheModule;
    exports.TranslateCacheService = TranslateCacheService;
    exports.TranslateCacheSettings = TranslateCacheSettings;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-translate-cache.umd.js.map
